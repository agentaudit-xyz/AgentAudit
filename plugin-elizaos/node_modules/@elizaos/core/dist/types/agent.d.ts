 ...
 */
export interface MessageExample extends Omit<ProtoMessageExample, "$typeName" | "$unknown" | "content"> {
    content: Content;
}
export interface MessageExampleGroup extends Omit<ProtoMessageExampleGroup, "$typeName" | "$unknown" | "examples"> {
    examples: MessageExample[];
}
export type CharacterSettings = Omit<ProtoCharacterSettingsType, "$typeName" | "$unknown" | "secrets"> & {
...
export type Character = Partial<Omit<ProtoCharacter, "$typeName" | "$unknown" | "settings" | "messageExamples" | "knowledge" | "secrets">> & {
 ...
 */
export interface Agent extends Character, Omit<ProtoAgent, "$typeName" | "$unknown" | "character" | "status" | "createdAt" | "updatedAt" | "secrets"> {
