 ...
 */
export interface ActionParameterSchema extends Omit<ProtoActionParameterSchema, "$typeName" | "$unknown" | "defaultValue" | "properties" | "items" | "enumValues"> {
 ...
 */
export interface ActionParameter extends Omit<ProtoActionParameter, "$typeName" | "$unknown" | "schema"> {
 ...
 */
export type ActionParameterExampleValue = ActionParameterValue | ActionParameters | ActionParameterValue[] | ActionParameters[];
/**
 ...
 */
export interface ActionExample extends Omit<ProtoActionExample, "$typeName" | "$unknown" | "content"> {
    content: Content;
}
export interface EvaluationExample extends Omit<ProtoEvaluationExample, "$typeName" | "$unknown" | "messages"> {
