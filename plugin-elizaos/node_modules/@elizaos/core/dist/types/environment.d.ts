...
export interface WorldMetadata extends Omit<ProtoWorldMetadata, "$typeName" | "$unknown" | "roles" | "extra" | "ownership"> {
    type?: string;
    description?: string;
...
export interface World extends Omit<ProtoWorld, "$typeName" | "$unknown" | "metadata"> {
    metadata?: WorldMetadata;
}
export interface Room extends Omit<ProtoRoom, "$typeName" | "$unknown" | "type" | "metadata"> {
    type: ChannelType;
    metadata?: Metadata;
 ...
 */
export interface Participant extends Omit<ProtoParticipant, "$typeName" | "$unknown" | "entity"> {
    entity: Entity;
}
/**
 * Represents a relationship between users
 */
export interface Relationship extends Omit<ProtoRelationship, "$typeName" | "$unknown" | "metadata"> {
    metadata?: Metadata;
}
