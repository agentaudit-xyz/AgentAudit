...
/**
 * Describes the file eliza/v1/environment.proto.
 */
export declare const file_eliza_v1_environment: GenFile;
/**
 * Entity component - extensible data attached to entities
 *
 * @generated from message eliza.v1.Component
 */
export type Component = Message<"eliza.v1.Component"> & {
    /**
...
/**
 * Describes the message eliza.v1.Component.
 ...
 *
 * @generated from message eliza.v1.Entity
 */
export type Entity = Message<"eliza.v1.Entity"> & {
    /**
     ...
     *
     * @generated from field: repeated eliza.v1.Component components = 5;
     */
    components: Component[];
};
/**
 * Describes the message eliza.v1.Entity.
 ...
 *
 * @generated from message eliza.v1.WorldOwnership
 */
export type WorldOwnership = Message<"eliza.v1.WorldOwnership"> & {
    /**
...
/**
 * Describes the message eliza.v1.WorldOwnership.
 ...
 * World metadata
 *
 * @generated from message eliza.v1.WorldMetadata
 */
export type WorldMetadata = Message<"eliza.v1.WorldMetadata"> & {
    /**
     * @generated from field: optional eliza.v1.WorldOwnership ownership = 1;
     */
...
/**
 * Describes the message eliza.v1.WorldMetadata.
 ...
 *
 * @generated from message eliza.v1.World
 */
export type World = Message<"eliza.v1.World"> & {
    /**
     * @generated from field: string id = 1;
     */
    id: string;
    ...
    /**
     * @generated from field: optional eliza.v1.WorldMetadata metadata = 5;
     */
    metadata?: WorldMetadata;
};
/**
 * Describes the message eliza.v1.World.
 ...
 *
 * @generated from message eliza.v1.RoomMetadata
 */
export type RoomMetadata = Message<"eliza.v1.RoomMetadata"> & {
    /**
...
/**
 * Describes the message eliza.v1.RoomMetadata.
 ...
 *
 * @generated from message eliza.v1.Room
 */
export type Room = Message<"eliza.v1.Room"> & {
    /**
     * @generated from field: string id = 1;
     */
    id: string;
    ...
    worldId?: string;
    /**
     * @generated from field: optional eliza.v1.RoomMetadata metadata = 9;
     */
    metadata?: RoomMetadata;
};
/**
 * Describes the message eliza.v1.Room.
 ...
 *
 * @generated from message eliza.v1.Participant
 */
export type Participant = Message<"eliza.v1.Participant"> & {
    /**
     * @generated from field: string id = 1;
     */
    id: string;
    /**
     * @generated from field: eliza.v1.Entity entity = 2;
     */
    entity?: Entity;
};
/**
 * Describes the message eliza.v1.Participant.
 ...
 *
 * @generated from message eliza.v1.Relationship
 */
export type Relationship = Message<"eliza.v1.Relationship"> & {
    /**
     * @generated from field: string id = 1;
     */
    id: string;
...
/**
 * Describes the message eliza.v1.Relationship.
