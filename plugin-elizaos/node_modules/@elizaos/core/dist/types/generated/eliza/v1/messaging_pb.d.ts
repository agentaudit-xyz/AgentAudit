...
/**
 * Describes the file eliza/v1/messaging.proto.
 */
export declare const file_eliza_v1_messaging: GenFile;
/**
 * Target information for message routing
 *
 * @generated from message eliza.v1.TargetInfo
 */
export type TargetInfo = Message<"eliza.v1.TargetInfo"> & {
    /**
...
/**
 * Describes the message eliza.v1.TargetInfo.
 ...
 *
 * @generated from message eliza.v1.MessageStreamChunkPayload
 */
export type MessageStreamChunkPayload = Message<"eliza.v1.MessageStreamChunkPayload"> & {
    /**
...
/**
 * Describes the message eliza.v1.MessageStreamChunkPayload.
 ...
 *
 * @generated from message eliza.v1.MessageStreamErrorPayload
 */
export type MessageStreamErrorPayload = Message<"eliza.v1.MessageStreamErrorPayload"> & {
    /**
     * @generated from field: string message_id = 1;
     */
    messageId: string;
...
/**
 * Describes the message eliza.v1.MessageStreamErrorPayload.
 ...
 *
 * @generated from message eliza.v1.MessageHandlerOptions
 */
export type MessageHandlerOptions = Message<"eliza.v1.MessageHandlerOptions"> & {};
/**
 * Describes the message eliza.v1.MessageHandlerOptions.
 ...
 *
 * @generated from message eliza.v1.MessageResult
 */
export type MessageResult = Message<"eliza.v1.MessageResult"> & {
    /**
     * @generated from field: string message_id = 1;
     */
    messageId: string;
    /**
     * @generated from field: optional eliza.v1.Memory user_message = 2;
     */
    userMessage?: Memory;
    /**
     * @generated from field: repeated eliza.v1.Content agent_responses = 3;
     */
    agentResponses: Content[];
    /**
     * @generated from field: optional eliza.v1.MessageUsage usage = 4;
     */
    usage?: MessageUsage;
};
/**
 * Describes the message eliza.v1.MessageResult.
 ...
 *
 * @generated from message eliza.v1.MessageUsage
 */
export type MessageUsage = Message<"eliza.v1.MessageUsage"> & {
    /**
...
/**
 * Describes the message eliza.v1.MessageUsage.
 ...
 *
 * @generated from enum eliza.v1.SocketMessageType
 */
...
/**
 * Describes the enum eliza.v1.SocketMessageType.
 */
