 ...
 */
export declare const LEGACY_EVENT_MAP: Record<string, EventType>;
/**
 ...
 */
export declare function mapLegacyEvent(legacyEvent: string): EventType | undefined;
/**
 ...
 */
export declare function mapLegacyEvents(legacyEvents: string[]): EventType[];
