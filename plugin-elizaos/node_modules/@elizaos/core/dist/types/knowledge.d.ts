 ...
 */
export type KnowledgeSourceItem = Omit<ProtoKnowledgeItem, "$typeName" | "$unknown" | "item"> & {
    item: {
        case: "path";
        value: string;
    } | {
 ...
 */
export type KnowledgeRecord = Partial<Omit<ProtoKnowledgeRecord, "$typeName" | "$unknown">>;
