 ...
 */
export interface BaseMetadata extends Omit<ProtoBaseMetadata, "$typeName" | "$unknown" | "type" | "scope" | "timestamp"> {
    type: MemoryTypeAlias;
    scope?: MemoryScope;
    timestamp?: number;
}
export interface DocumentMetadata extends Omit<ProtoDocumentMetadata, "$typeName" | "$unknown" | "base"> {
    base?: BaseMetadata;
    type?: "document";
}
export interface FragmentMetadata extends Omit<ProtoFragmentMetadata, "$typeName" | "$unknown" | "base"> {
    base?: BaseMetadata;
    documentId: UUID;
    position: number;
    type?: "fragment";
...
export interface MessageMetadata extends Omit<ProtoMessageMetadata, "$typeName" | "$unknown" | "base"> {
    base?: BaseMetadata;
    type?: "message";
...
export interface DescriptionMetadata extends Omit<ProtoDescriptionMetadata, "$typeName" | "$unknown" | "base"> {
    base?: BaseMetadata;
    type?: "description";
}
/**
 ...
 */
export interface CustomMetadata extends Omit<ProtoCustomMetadata, "$typeName" | "$unknown" | "base"> {
    base?: BaseMetadata;
    type?: "custom";
 ...
 */
export interface Memory extends Omit<ProtoMemory, "$typeName" | "$unknown" | "id" | "createdAt" | "embedding" | "metadata" | "content"> {
    id?: UUID;
    createdAt?: number;
    embedding?: number[];
