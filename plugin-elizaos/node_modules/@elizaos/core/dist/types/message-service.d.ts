 ...
 */
export interface MessageProcessingOptions extends Omit<ProtoMessageProcessingOptions, "$typeName" | "$unknown" | "maxRetries" | "timeoutDuration" | "useMultiStep" | "maxMultiStepIterations" | "shouldRespondModel"> {
    maxRetries?: number;
...
export type ShouldRespondModelType = ProtoShouldRespondModelType | "small" | "large";
export type MessageProcessingMode = ProtoMessageProcessingMode | "simple" | "actions" | "none" | "blocked";
/**
