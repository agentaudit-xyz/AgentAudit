 ...
 */
export interface MessageStreamChunkPayload extends Omit<ProtoMessageStreamChunkPayload, "messageId" | "agentId"> {
    messageId: UUID;
    agentId: UUID;
}
/**
 ...
 * Uses camelCase for client-facing WebSocket events (JS convention)
 */
export interface MessageStreamErrorPayload extends Omit<ProtoMessageStreamErrorPayload, "messageId" | "agentId"> {
    messageId: UUID;
    agentId: UUID;
}
/**
 ...
 */
export interface MessageResult extends Omit<ProtoMessageResult, "messageId" | "userMessage" | "agentResponses"> {
    messageId: UUID;
    userMessage?: Memory;
