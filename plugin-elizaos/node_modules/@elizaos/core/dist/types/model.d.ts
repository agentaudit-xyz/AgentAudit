 ...
 */
export interface GenerateTextParams extends Omit<ProtoGenerateTextParams, "$typeName" | "$unknown" | "responseFormat" | "stopSequences"> {
    responseFormat?: {
 ...
 */
export interface TokenUsage extends Omit<ProtoTokenUsage, "$typeName" | "$unknown"> {
}
/**
 * Represents a single chunk in a text stream.
 * Each chunk contains a piece of the generated text.
 */
export interface TextStreamChunk extends Omit<ProtoTextStreamChunk, "$typeName" | "$unknown"> {
}
/**
 ...
 */
export interface GenerateTextOptions extends Omit<ProtoGenerateTextOptions, "$typeName" | "$unknown" | "modelType"> {
 ...
 */
export interface GenerateTextResult extends Omit<ProtoGenerateTextResult, "$typeName" | "$unknown"> {
}
/**
 * Parameters for text tokenization models
 */
export interface TokenizeTextParams extends Omit<ProtoTokenizeTextParams, "$typeName" | "$unknown" | "modelType"> {
 ...
 */
export interface DetokenizeTextParams extends Omit<ProtoDetokenizeTextParams, "$typeName" | "$unknown" | "modelType"> {
    modelType: ModelTypeName;
}
/**
 * Parameters for text embedding models
 */
export interface TextEmbeddingParams extends Omit<ProtoTextEmbeddingParams, "$typeName" | "$unknown"> {
}
/**
 * Parameters for image generation models
 */
export interface ImageGenerationParams extends Omit<ProtoImageGenerationParams, "$typeName" | "$unknown"> {
}
/**
 * Parameters for image description models
 */
export interface ImageDescriptionParams extends Omit<ProtoImageDescriptionParams, "$typeName" | "$unknown"> {
}
export interface ImageDescriptionResult extends Omit<ProtoImageDescriptionResult, "$typeName" | "$unknown"> {
}
export interface ImageGenerationResult extends Omit<ProtoImageGenerationResult, "$typeName" | "$unknown"> {
}
/**
 * Parameters for transcription models
 */
export interface TranscriptionParams extends Omit<ProtoTranscriptionParams, "$typeName" | "$unknown"> {
}
/**
 * Parameters for text-to-speech models
 */
export interface TextToSpeechParams extends Omit<ProtoTextToSpeechParams, "$typeName" | "$unknown"> {
}
/**
 * Parameters for audio processing models
 */
export interface AudioProcessingParams extends Omit<ProtoAudioProcessingParams, "$typeName" | "$unknown"> {
}
/**
 * Parameters for video processing models
 */
export interface VideoProcessingParams extends Omit<ProtoVideoProcessingParams, "$typeName" | "$unknown"> {
}
/**
 ...
 */
export interface JSONSchema extends Omit<ProtoJSONSchema, "$typeName" | "$unknown" | "type" | "properties" | "items" | "required"> {
    type?: string | string[];
 ...
 */
export interface ObjectGenerationParams extends Omit<ProtoObjectGenerationParams, "$typeName" | "$unknown" | "modelType" | "schema" | "enumValues" | "stopSequences"> {
    schema?: JSONSchema;
    modelType?: ModelTypeName;
    enumValues?: string[];
    stopSequences?: string[];
