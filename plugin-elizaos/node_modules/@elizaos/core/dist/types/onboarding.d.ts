...
export type OnboardingInput = {
    step: typeof OnboardingStep.WELCOME;
    data: WelcomeInput;
} | {
    step: typeof OnboardingStep.RISK_ACK;
    data: RiskAckInput;
} | {
    step: typeof OnboardingStep.AUTH;
    data: AuthInput;
} | {
    step: typeof OnboardingStep.CHANNELS;
    data: ChannelsInput;
} | {
    step: typeof OnboardingStep.SKILLS;
    data: SkillsInput;
} | {
    step: typeof OnboardingStep.COMPLETE;
 ...
 */
export declare function getNextStep(currentStep: OnboardingStep): OnboardingStep | null;
/**
 * Get the previous step in the sequence, or null if at the beginning.
 */
export declare function getPreviousStep(currentStep: OnboardingStep): OnboardingStep | null;
/**
