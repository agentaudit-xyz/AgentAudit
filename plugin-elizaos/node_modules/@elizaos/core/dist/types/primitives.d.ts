...
import type { JsonObject, Content as ProtoContent, JsonValue as ProtoJsonValue, Media as ProtoMedia, MentionContext as ProtoMentionContext } from "./proto.js";
 ...
 */
export type ContentValue = ProtoJsonValue | undefined | ContentValue[] | {
 ...
 */
export interface Content extends Omit<ProtoContent, "$typeName" | "$unknown" | "actions" | "providers" | "attachments" | "channelType" | "inReplyTo" | "mentionContext" | "responseMessageId" | "responseId"> {
     ...
     */
    [key: string]: ContentValue | ChannelType | MentionContext | Media[] | Content | UnknownField[] | undefined;
}
/**
 * Platform-provided metadata about mentions.
 ...
 */
export interface MentionContext extends Omit<ProtoMentionContext, "$typeName" | "$unknown"> {
 ...
 */
export type Media = Omit<ProtoMedia, "$typeName" | "$unknown" | "contentType"> & {
    /** Unique identifier */
    id: string;
    /** Media URL */
    url: string;
 ...
 */
export type MetadataValue = ProtoJsonValue | undefined | MetadataValue[] | {
