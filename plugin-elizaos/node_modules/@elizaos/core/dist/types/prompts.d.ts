...
import type { BuildPromptOptions as ProtoBuildPromptOptions, BuiltPrompt as ProtoBuiltPrompt, PromptFieldInfo as ProtoPromptFieldInfo, PromptTemplateConfig as ProtoPromptTemplateConfig } from "./proto.js";
/**
 ...
 */
export interface BuildPromptOptions extends Omit<ProtoBuildPromptOptions, "template" | "state" | "defaults"> {
 ...
 */
export interface PromptTemplateConfig extends Omit<ProtoPromptTemplateConfig, "template" | "defaults"> {
    template: TemplateType;
    defaults?: Record<string, string>;
