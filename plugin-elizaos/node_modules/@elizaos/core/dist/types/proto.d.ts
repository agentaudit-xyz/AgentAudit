 ...
 */
import type { JsonObject as BufJsonObject, JsonValue as BufJsonValue } from "@bufbuild/protobuf";
 ...
 */
export declare function toJson<T extends JsonObject>(message: T): JsonObject;
/**
 * Helper to create a proto message from a plain object
 */
export declare function fromJson<T extends object>(schema: {
    new (): T;
}, json: JsonObject): T;
