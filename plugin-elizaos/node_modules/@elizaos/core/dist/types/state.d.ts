...
export interface ActionPlanStep extends Omit<ProtoActionPlanStep, "$typeName" | "$unknown" | "result"> {
    status: "pending" | "completed" | "failed";
    result?: ActionResult;
}
/** Multi-step action plan */
export interface ActionPlan extends Omit<ProtoActionPlan, "$typeName" | "$unknown" | "steps" | "metadata"> {
 ...
 */
export interface ProviderCacheEntry extends Omit<ProtoProviderCacheEntry, "$typeName" | "$unknown" | "values" | "data"> {
 ...
 */
export interface WorkingMemoryEntry extends Omit<ProtoWorkingMemoryItem, "$typeName" | "$unknown" | "result" | "timestamp"> {
    result: ActionResult;
    timestamp: number;
}
/**
 ...
 */
export interface StateData extends Omit<ProtoStateData, "$typeName" | "$unknown" | "room" | "world" | "entity" | "providers" | "actionPlan" | "actionResults" | "workingMemory"> {
 ...
 */
export interface StateValues extends Omit<ProtoStateValues, "$typeName" | "$unknown" | "extra"> {
    /** Agent name */
    agentName?: string;
 ...
 */
export interface State extends Omit<ProtoState, "$typeName" | "$unknown" | "values" | "data"> {
    values: StateValues;
    data: StateData;
