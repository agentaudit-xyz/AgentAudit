 ...
 */
export interface TaskMetadata extends Omit<ProtoTaskMetadata, "$typeName" | "$unknown" | "values"> {
 ...
 */
export interface Task extends Omit<ProtoTask, "$typeName" | "$unknown" | "id" | "roomId" | "worldId" | "entityId" | "metadata" | "createdAt" | "updatedAt" | "dueAt" | "status"> {
    id?: UUID;
    roomId?: UUID;
    worldId?: UUID;
    entityId?: UUID;
